...
.footer-text {font-size:14px;color:#fff;line-height:1.6;max-width:1200px;margin:0 auto;}
.footer-text b.navin {font-weight:700;cursor:pointer;color:#ff4b2b;background:linear-gradient(45deg,#ff4b2b,#ff8c00,#f9d423,#ff4b2b);background-size:400% 400%;-webkit-background-clip:text;-webkit-text-fill-color:transparent;animation:fireFlicker 2s infinite;}
@keyframes fireFlicker {0%{background-position:0% 50%;text-shadow:0 0 4px #ff416c,0 0 8px #ff4b2b;}25%{background-position:50% 50%;text-shadow:0 0 6px #ff416c,0 0 10px #ff4b2b;}50%{background-position:100% 50%;text-shadow:0 0 4px #f9d423,0 0 12px #ff4b2b;}75%{background-position:50% 50%;text-shadow:0 0 8px #ff416c,0 0 14px #ff4b2b;}100%{background-position:0% 50%;text-shadow:0 0 6px #ff416c,0 0 10px #ff4b2b;}}
.footer-text a {text-decoration:none;color:#ff4b2b;transition:color 0.3s;}
.footer-text a:hover {color:#ffa500;}
.footer-separator {width:50px;height:2px;background:#ff4b2b;margin:12px auto;border-radius:2px;}
.footer-icons {margin-top:12px;}
.footer-icons a {display:inline-block;margin:0 10px;transition:transform 0.3s,filter 0.3s;}
.footer-icons a:hover {transform:scale(1.2);filter:brightness(1.5);}
.footer-icons a.github img {filter:invert(50%) sepia(100%) saturate(500%) hue-rotate(10deg) brightness(1.3);transition:filter 0.3s;}
.footer-icons a.github:hover img {filter:invert(0%) sepia(100%) saturate(800%) hue-rotate(10deg) brightness(1.6);}
